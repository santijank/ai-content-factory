#!/usr/bin/env python3
"""
Performance Optimization for AI Content Factory
แก้ไขปัญหา Response Time ช้า
"""
...
def optimize_database():
    ...
    indexes = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_trends_popularity ON trends(popularity_score)",
        "CREATE INDEX IF NOT EXISTS idx_opportunities_created_at ON content_opportunities(created_at)",
        "CREATE INDEX IF NOT EXISTS idx_opportunities_priority ON content_opportunities(priority_score)",
        "CREATE INDEX IF NOT EXISTS idx_opportunities_trend_id ON content_opportunities(trend_id)",
        "CREATE INDEX IF NOT EXISTS idx_content_items_opportunity_id ON content_items(opportunity_id)"
    ]
    ...
    # VACUUM database เพื่อ defragment
    print("🗜️ Compacting database...")
    cursor.execute("VACUUM")
    
    # ANALYZE เพื่อปรับปรุง query planner
...
def add_caching_decorator():
    """สร้าง decorator สำหรับ caching"""
    cache = {}
    cache_timeout = {}
...
def create_optimized_app():
    """สร้าง app.py ที่ปรับปรุงประสิทธิภาพแล้ว"""
    print("🚀 Creating optimized app...")
    
    optimized_code = '''from flask import Flask, jsonify, request
import sqlite3
import json
...
'''
    ...
    with open('simple_app_optimized.py', 'w', encoding='utf-8') as f:
        f.write(optimized_code)
    
    print("✅ Created simple_app_optimized.py")

def main():
    """รันการปรับปรุงประสิทธิภาพ"""
    print("⚡ AI Content Factory - Performance Optimization")
    print("=" * 60)
    ...
    print("✅ Query planner optimized (ANALYZE)")
    print("✅ Response caching added")
    print("✅ HTML minified")
    print("✅ Database pragmas optimized")
    print("✅ Transaction-based operations")
    print("✅ Threaded Flask server")
    
    print("\n🚀 Next steps:")
    print("1. Stop current server (Ctrl+C)")
    print("2. Run: python simple_app_optimized.py")
    print("3. Test again: python test_system.py")
    
    print("\n💡 Expected improvements:")
    print("⚡ Response time: < 500ms")
    print("📊 Success rate: 100%")
    print("🔄 Better concurrent handling")
