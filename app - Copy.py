#!/usr/bin/env python3
"""
AI Content Factory - Main Application
...
class AIContentFactory:
    ...
    def collect_trends(self):
        ...
        try:
            from trend_monitor.trend_collector import TrendCollectorManager
    ...
    def analyze_trends(self):
        ...
        try:
            from content_engine.ai_trend_analyzer import OpportunityGenerator
        ...
        try:
            ...
            if opportunities:
                ...
                for i, opp in enumerate(opportunities[:5], 1):
                    ...
                    print(f"      Score: {opp['priority_score']:.1f} | Views: {opp['estimated_views']:,}")
            ...
            if trends:
                ...
                for i, trend in enumerate(sorted_trends[:5], 1):
                    ...
                    print(f"      Score: {trend['popularity_score']:.1f} | Source: {trend['source']}")
